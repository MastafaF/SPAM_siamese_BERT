...
class EmbeddingSimilarityEvaluatorNew(SentenceEvaluator):
    """
    ...
    def __call__(self, model: 'SequentialSentenceEmbedder', output_path: str = None, epoch: int = -1,
        ...
        labels_pred.append(dot_products)  # Added Mastafa
        ...
        if self.main_similarity == SimilarityFunction.COSINE:
            return eval_spearman_cosine, labels_pred
        elif self.main_similarity == SimilarityFunction.EUCLIDEAN:
            return eval_spearman_euclidean, labels_pred
        elif self.main_similarity == SimilarityFunction.MANHATTAN:
            return eval_spearman_manhattan, labels_pred
        elif self.main_similarity == SimilarityFunction.DOT_PRODUCT:
            return eval_spearman_dot, labels_pred
        elif self.main_similarity is None:
            return max(eval_spearman_cosine, eval_spearman_manhattan, eval_spearman_euclidean,
                       eval_spearman_dot), labels_pred
        else:
